...
* The original package name 'com.example.chat-app-api' is invalid and this project uses 'com.example.chatappapi' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.2.0-M1/reference/htmlsinge/index.html#messaging.websockets)
